...
namespace Course.WEB.Models
{
    ...
    public class StoreDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext db)
        {
            ...
            {
                Id = 1, Name = "Тригонометрия", DisciplineId = 1, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            ...
            db.Courses.Add(new de.Course
            {
                Id = 2, Name = "Высшая математика", DisciplineId = 1, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Высшая математика"
            });
            db.Courses.Add(new de.Course
            {
                Id = 3, Name = "Теория вероятности", DisciplineId = 1, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Теория вероятности"
            });
            db.Courses.Add(new de.Course
            {
                Id = 4, Name = "Школьная физика", DisciplineId = 2, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Школьная физика"
            });
            db.Courses.Add(new de.Course
            {
                Id = 5, Name = "Высшая физика", DisciplineId = 2, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Высшая физика"
            });
            db.Courses.Add(new de.Course
            {
                Id = 6, Name = "Теория физики", DisciplineId = 2, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Теория физики"
            });
            db.Courses.Add(new de.Course
            {
                Id = 7, Name = "Прикладная экономика", DisciplineId = 3, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Прикладная экономика"
            });
            db.Courses.Add(new de.Course
            {
                Id = 8, Name = "Высшая экономика", DisciplineId = 3, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Высшая экономика"
            });
            db.Courses.Add(new de.Course
            {
                Id = 9, Name = "Теория экономики", DisciplineId = 3, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Теория экономики"
            });
            db.Courses.Add(new de.Course
            {
                Id = 10, Name = "Прикладная химия", DisciplineId = 4, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Прикладная химия"
            });
            db.Courses.Add(new de.Course
            {
                Id = 11, Name = "Высшая химия", DisciplineId = 4, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Высшая химия"
            });
            db.Courses.Add(new de.Course
            {
                Id = 12, Name = "Теория химии", DisciplineId = 4, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме Теория химии"
            });
            db.Courses.Add(new de.Course
            {
                Id = 13, Name = "ООП", DisciplineId = 5, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            Description = "Этот курс предназначен для тренировки решения задач по теме ООП"
            });
            db.Courses.Add(new de.Course
            {
                Id = 14, Name = "Базы Данных", DisciplineId = 5, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
            ...
            {
                Id = 1, Name = "Метод вспомогательного аргумента",
            ...
            db.Topics.Add(new Topic
            {
                Id = 2, Name = "Тригонометрические уравнения",
            ...
            db.Topics.Add(new Topic
            {
                Id = 3, Name = "Однородные уравнения",
            ...
            db.Topics.Add(new Topic
            {
                Id = 4, Name = "Дифференциальные уравнения",
            ...
            db.Topics.Add(new Topic
            {
                Id = 9, Name = "Статистическая физика",
                PlannedComplexity = 0.9m,
                CourseId = 4, CreatorId = "65c13a33-5a3e-450c-bd46-503f878e929d",
